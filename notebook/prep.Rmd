...
ggplot(test2) + 
  geom_bar(aes(y = percent, x = icprb_bioregion_id, fill = rating), data = test2,
                           stat="identity") +
...
slices <- c(15.487036, 25.998598, 29.642607, 27.049755, 1.822004)
lbls <- c("Excellent", "Good", "Fair", "Poor", "Very Poor")
pie(slices, labels = lbls, main="NAPU Ratings", col= c("darkgreen", "green3","yellow2", "orange2", "red3"))
